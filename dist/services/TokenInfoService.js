...
var tokenListProvider = new spl_token_registry_1.TokenListProvider();
var tokenInfoByAddress = undefined;
function getTokenInfo(tokenAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var tokenList, tokenInfos, _i, tokenInfos_1, tokenInfo;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!!tokenInfoByAddress) return [3 /*break*/, 2];
                    tokenInfoByAddress = {};
                ...
                case 1:
                    ...
                    _a.label = 2;
                case 2: return [2 /*return*/, tokenInfoByAddress[tokenAddress]];
            }
        });
    });
}
