...
var TokenSnapshot_1 = require("../entities/TokenSnapshot");
var SqlService = __importStar(require("../services/SqlService"));
var insert = function (tokenBalance) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    connection = _a.sent();
                    repository = connection.getRepository(TokenSnapshot_1.TokenSnapshot);
                    snapshot = new TokenSnapshot_1.TokenSnapshot();
